...
- 29d2952: Fix a build failure in every application that does not install the optional
  `@quantajs/devtools` peer.
    ...
    reachable from the main entry. Any application importing _anything_ from
